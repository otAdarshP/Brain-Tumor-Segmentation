...
This provides a Deep Convolutional Neural Network (DCAN) Architecture designed for brain tumor segmentation with BraTS2017 dataset. 
...
1) adopting a patch-based training approach; 
2) using a custom loss function that accounts for the imbalance. 
